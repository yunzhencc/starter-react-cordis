...
describe('uiThemePlugin', () => {
  ...
  it('contributes the theme service, appearance settings item, header toggle, and removable styles', async () => {
    ...
    expect(runtime.getSlotItems('shell.content.header')).toEqual([]);
